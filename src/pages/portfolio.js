    ...
    <div className="profile">
      <div className="project-main">
        <div className="project-block">
          ...
          <div className="project-content">
            <p>
              블레이버스 MVP 개발 해커톤 출품 프로젝트입니다. 창업팀의 아이템(헤어스타일 컨설팅 예약 서비스)를 MVP로 개발을 진행하였습니다. 헤어스타일
              컨설팅을 받고자 하는 고객들이 원하는 디자이너를 찾아 예약을 하고, 결제를 진행할 수 있는 서비스입니다.
            </p>
      ...
      <div className="project-main">
        <div className="project-block">
          ...
          <div className="project-content">
            <p>
              Jetbrains Space 사용자들을 위한 커뮤니케이션 도구로, 다양한 게시판에 자유롭게 참여해 메시지를 나눌 수 있는 Extension. <br />
          ...
          <div className="project-content">
            ...
            <div className="project-content-items">
              ...
              <ul>
                ...
                <li>년간, 분기, 월간 회의 시 회고를 통해 잘한 점과 개선할 점을 도출해 다음 스프린트에 반영</li>
          ...
          <div className="project-content">
            ...
            <div className="project-content-items">
              ...
              <ul>
                ...
                <li>월간 회의 시 회고를 통해 잘한 점과 개선할 점을 도출해 다음 스프린트에 반영</li>
        ...
        <div className="project-block">
          ...
          <div className="project-content">
            <p>
              ...
              사용자가 직접 행사를 공유하고, 다양한 사용자와 행사에 대한 이야기를 나눌 수 있는 커뮤니티 앱입니다. 네이티브 앱에 웹 뷰를 이식하는
              방법으로 개발하고 있습니다. 현재 v0.1.0을 개발하고 있고, 올해 안으로 서비스를 목표로 개발을 진행하고 있습니다.
            </p>
            <div className="project-links">
              ...
              <a href="https://beyond-imagination.notion.site/Fienmee-681b57bc497344bb86821f077a42297e" target="_blank" rel="noreferrer">
          ...
          <div className="project-content">
            ...
            <div className="project-content-items">
              ...
              <ul>
                <li>로그인 페이지 개발</li>
                <li>
                  <a href="https://github.com/Beyond-Imagination/fienmee/pull/78">알려진 이슈를 해결하기 위해 React Native Migration</a>
                </li>
              </ul>
            </div>
            <div className="project-content-items">
